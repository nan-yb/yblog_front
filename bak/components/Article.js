...
const Article = ({ article, comment, user }) => {
  return (
    <div>
      <div className="mx-auto my-4 max-w-screen-xl">
        <div className="w-6/12 justify-center mx-auto">
          ...
          <div className="flex justify-between text-base">
            <div>
              <span className="inline-flex  text-gray-500 font-bold items-center px-2 ">
                <svg
            ...
            <div>
              <span className="inline-flex text-gray-500 font-bold items-center px-2 ">
                {user.email === article.author.email ? (
                  <div>
                    <button className="px-1" onClick={updateArticle}>
                      수정
                    </button>
                    <button className="px-1" onClick={deleteArticle}>
                      삭제
                    </button>
                  </div>
                ) : null}
